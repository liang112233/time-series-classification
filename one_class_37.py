...
path = '/home/liang/PycharmProjects/time-series-classification/dell-chrome-dataset/training/'
sequences = list()
sequences1 = list()
...
labels = np.loadtxt('/home/liang/PycharmProjects/time-series-classification/dell-chrome-dataset/training/target_cp')
label = labels[:,1]
...
#
x_train, x_test, y_train, y_test = train_test_split(train_data, label, test_size = 0.04, random_state = 0)
...
out = keras.layers.Dense(num_class,activation='softmax')(full)
