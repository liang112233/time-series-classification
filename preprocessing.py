...
for j in range(1,6):
    ...
    for i in range(1,101):
        ...
        pkgPower = getpower(pkgEnergy)[0:200]
...
seq_len = 200  # each dataset has 2999 samples
#

train_data = np.reshape(sequences, (500, 200, -1))
...
def baseline_model():
    ...
    model.add(LSTM(512, input_shape=(200, 1)))
